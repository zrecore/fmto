...
async function matrixSubtract(device, mat1, mat2)
{
    ...
    if (mat1.length != mat2.length) {
        throw "math/linearAlgebra matrixSubtract() arguments mat1 and mat2 must match dimensions (R^2 to R^4)."
    }
    if (mat1.length < 2) {
        throw "math/linearAlgebra matrixSubtract() arguments mat1 and mat2 must be at least R^2."
    }
    if (mat1.length > 4) {
        throw "math/linearAlgebra matrixSubtract() only supports up to R^4 for arguments mat1 and mat2."
    }
